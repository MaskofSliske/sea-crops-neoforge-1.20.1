...
public class CactusUrchinModel<T extends Entity> extends EntityModel<T> {
	...
	public void setupAnim(CactusUrchinEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
